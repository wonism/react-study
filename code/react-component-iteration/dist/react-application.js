...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(Address, null);
	    }
	  }]);
	...
	var Address = function (_React$Component2) {
	  ...
	  function Address(props) {
	    ...
	    _this2.state = {
	      addressDatas: [{ name: 'Albert', phoneNumber: '010-0001-1234' }, { name: 'Bob', phoneNumber: '010-0002-1234' }, { name: 'Charles', phoneNumber: '010-0003-1234' }, { name: 'David', phoneNumber: '010-0004-1234' }],
	      selectedKey: -1,
	      selected: {
	        name: "",
	        phoneNumber: ""
	  ...
	  _createClass(Address, [{
	    ...
	    key: '_insertAddress',
	    value: function _insertAddress(name, phoneNumber) {
	    ...
	    key: '_editAddress',
	    value: function _editAddress(name, phoneNumber) {
	      this.setState({
	        addressDatas: (0, _reactAddonsUpdate2.default)(this.state.addressDatas, _defineProperty({}, this.state.selectedKey, {
	          name: { $set: name },
	    ...
	    value: function _removeAddress() {
	      if (this.state.selectedKey === -1) {
	        ...
	        this.setState({
	          addressDatas: (0, _reactAddonsUpdate2.default)(this.state.addressDatas, { $splice: [[this.state.selectedKey, 1]] }),
	          selectedKey: -1
	        });
	      }
	    }
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'ul',
	          null,
	          this.state.addressDatas.map(function (address, index) {
	            return _react2.default.createElement(AddressData, {
	              name: address.name, phoneNumber: address.phoneNumber, key: index,
	              addressKey: index,
	              isSelected: _this3._isSelected.bind(_this3)(index),
	              onSelect: _this3._onSelect.bind(_this3)
	            });
	          })
	        ),
	        _react2.default.createElement(AddressAdder, { onInsert: this._insertAddress.bind(this) }),
	        _react2.default.createElement(AddressRemover, { onRemove: this._removeAddress.bind(this) }),
	        _react2.default.createElement(AddressEditor, { onEdit: this._editAddress.bind(this), isSelected: this.state.selectedKey !== -1, address: this.state.selected })
	      );
	    }
	  }]);
	...
	var AddressData = function (_React$Component3) {
	  _inherits(AddressData, _React$Component3);

	  function AddressData() {
	    _classCallCheck(this, AddressData);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(AddressData).apply(this, arguments));
	  }

	  _createClass(AddressData, [{
	    key: 'handleClick',
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'li',
	        { style: getStyle(this.props.isSelected), onClick: this.handleClick.bind(this) },
	        this.props.name,
	        ' ',
	...
	var AddressAdder = function (_React$Component4) {
	  _inherits(AddressAdder, _React$Component4);

	  function AddressAdder(props) {
	    _classCallCheck(this, AddressAdder);

	    var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(AddressAdder).call(this, constructor));
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { type: 'text', name: 'phoneNumber', placeholder: 'phone number', value: this.state.phoneNumber, onChange: this.handleChange.bind(this) })
	        ),
	        _react2.default.createElement(
	          'div',
	          null,
	...
	var AddressEditor = function (_React$Component5) {
	  _inherits(AddressEditor, _React$Component5);

	  function AddressEditor(props) {
	    _classCallCheck(this, AddressEditor);

	    var _this6 = _possibleConstructorReturn(this, Object.getPrototypeOf(AddressEditor).call(this, constructor));
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { type: 'text', name: 'phoneNumber', placeholder: 'phoneNumber', value: this.state.phoneNumber,
	            onChange: this.handleChange.bind(this) })
	        ),
	        _react2.default.createElement(
	          'div',
	...
	var AddressRemover = function (_React$Component6) {
	  _inherits(AddressRemover, _React$Component6);

	  function AddressRemover() {
	    _classCallCheck(this, AddressRemover);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(AddressRemover).apply(this, arguments));
	  }

	  _createClass(AddressRemover, [{
	    key: 'handleClick',
	    value: function handleClick() {
	      this.props.onRemove();
	    }
